                                   ...
                                   {  if($primeravez==0)
                                     ...
                                     if ($numfila==0)
                                      ...
                                      { echo "<tr class='alt'>" ;
                                       ...
                                       echo  "<td>" . "<a href='puntuacion2.php?dorsal=". $fila["Dorsal"] . "&club=" . $fila["NombreClub"] . "&tipoejercicio=" . $tipoejercicio ."&podium=" .$podium ."'>".  $fila["Dorsal"] .  "</a></td>";
