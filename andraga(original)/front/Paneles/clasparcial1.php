...
and podium.idPodium=" . $podium ;
    if ($autonomico)
     $sql=$sql . " and inscripcion.autonomico=1";
    $sql=$sql .  ") ORDER BY  Total DESC, Dorsal ASC";

    //echo $sql;

    
   $sql2="SELECT texto, desPodium, autonomico FROM desPodium WHERE idPodium=" . $podium;
   ...
   <header>
            	...
            	<div class="content">
            	 <div class="nivel">
                        <?php
                        echo "<b><center>" . $fila['Categoria'] . "</b></center>  " ;
                 //echo $fila["especialidad"] . " ". $fila["Categoria"] . "  " . $fila["TipoEjercicio"] . " <br/></span><br/>";
                                   ...
                                   {  if($primeravez==0)
                                     ...
                                     if ($numfila>3)
                                      ...
                                      // echo  "<td>" .  $fila["Dorsal"] .  "</td>";
                                       echo   "<td><span class='columna'>" .substr($fila["NombreClub"], 0, 5). "</span></td>";
