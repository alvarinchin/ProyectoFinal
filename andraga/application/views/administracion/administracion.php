    ...
    <div class="row">
        ...
        <div  class="col-md-3">
            <div ng-controller="clubCtrl">
                ...
                <h4 class="well" data-toggle="collapse" data-target="#clubN">Nuevo Club</h4>
                ...
                <table class="table">
                    <tr  ng-repeat="club in clubes">
                        ...
                        <td><button class="btn btn-primary" ng-click="datos(club)"data-toggle="collapse" data-target="#clubE"><span class="glyphicon glyphicon-pencil"></span></button></td>
            ...
            <div ng-controller="tipoCtrl">
                ...
                <div id="tipoN" class="collapse well">
                    <div class="form-group">
                        ...
                        <input type="text" ng-model="descripcion">
                    </div>
                    <button type="button" ng-click="insertar();" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span></button>
                </div>
