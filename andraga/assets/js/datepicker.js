angular
		...
		.directive(
				...
				[
						...
						function(a) {
							var b = function(d, c) {
								d.format = c.format || "DD-MM-YYYY";
								d.viewFormat = c.viewFormat || "Do MMMM YYYY";
								d.locale = c.locale || "es";
								d.firstWeekDaySunday = d
										.$eval(c.firstWeekDaySunday) || false;
							...
							return {
								...
								link : function(g, e, d, j) {
									...
									var c = moment();
									var f = function(l) {
										var k = l.endOf("month").date(), q = l
												.month(), p = l.year(), r = 1;
										var o = g.firstWeekDaySunday === true ? l
												.set("date", 2).day()
												: l.set("date", 1).day();
										if (o !== 1) {
											r -= o - 1
									...
									var h = function() {
										var k = g.firstWeekDaySunday === true ? moment("2015-06-07")
												: moment("2015-06-01");
										for (var l = 0; l < 7; l += 1) {
